...
const Hero = () => {
    return (
        <div className='' id='Home'>
            ...
            <div className='flex flex-col items-center justify-center lg:px-16 bg-main py-6 p-8 h-[70vh]'>
                <div className='grid lg:grid-cols-2 items-center lg:justify-around justify-center  gap-24 '>
                    <div className='flex flex-col gap-3 text-white lg:items-start items-center '>
                        <Fade top><h1 className='font-extrabold lg:text-[76px] md:text-6xl text-4xl'>MEMOI</h1></Fade>
                        <Fade bottom><h1 className='font-extrabold lg:text-[76px] md:text-6xl text-4xl '>AFRICA</h1></Fade>
                        <LightSpeed top><p className='ease-in duration-300 lg:text-left text-center text-gray-300 text-xs'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iure nam nobis natus dolore earum a magni voluptates officiis vitae rem eum sit, quisquam repellendus numquam laudantium deserunt, doloribus consectetur labore?</p></LightSpeed>
                        {/* button */}
            ...
            {/* progress counter */}
            <div className='flex items-center justify-evenly mt-1 py-10 w-full bg-[#1E3A8A] text-white lg:px-8 px-2'>
                <div className='flex flex-col items-center'>
                    <h1 className='font-bold lg:text-4xl text-2xl overflow-hidden text-white'>10+</h1>
                ...
                <div className='flex flex-col items-center'>
                    <h1 className='font-bold lg:text-4xl text-2xl overflow-hidden text-white'>100%</h1>
