    ...
    return (
        <div className=" w-[100%] bg-main p-4 py-8">
            <div className='flex flex-col items-center text-center'>
                <h1 className='font-extrabold lg:text-5xl md:text-4xl text-3xl text-white'>The Team</h1>
            </div>
            <Swiper
                slidesPerView={3}
                spaceBetween={5}
                ...
                {TeamsData.map((team, ind) => (
                    <SwiperSlide key={team.id} style={{ width: '300px' }} className='w-max mt-8 mb-8 flex flex-col items-center text-white '>
                        <div className='rounded-3xl mb-8'>
                            ...
                            <div className='flex flex-col bg-[#1E3A8A] items-center justify-center gap-2  shadow-black shadow-2xl w-full rounded-b-3xl py-4'>
