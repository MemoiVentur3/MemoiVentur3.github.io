...
import img1 from '../../assets/Main/Incubator.png'
    ...
    <div className=" w-[100%] flex items-center flex-col relative justify-center p-4 py-8 bg-main text-white">
      <div className='lg:w-[70%]'>
        <div className='flex flex-col items-center text-center mb-6'>
          <h1 className='font-extrabold lg:text-4xl md:text-4xl text-4xl text-white'>Incubator &</h1>
          <h1 className='font-extrabold lg:text-4xl md:text-4xl text-4xl text-white'>Accelerate</h1>
        </div>
        <div className='mt-2 text-center text-gray-300 font-semibold'>
