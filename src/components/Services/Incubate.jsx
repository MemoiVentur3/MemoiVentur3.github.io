    ...
    <div className=" w-[100%] flex items-center flex-col relative justify-center p-4 py-8 bg-main text-white">
      <div className='lg:w-[70%]'>
        <div className='flex flex-col items-center text-center mb-6'>
          <h1 className='font-semibold lg:text-5xl md:text-4xl text-3xl text-white'>Incubator &</h1>
          <h1 className='font-semibold lg:text-5xl md:text-4xl text-3xl text-white'>Accelerate</h1>
        </div>
